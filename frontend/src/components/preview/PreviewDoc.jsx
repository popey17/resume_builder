...
const PreviewDoc = () => {
  ...
  return (
    <div className="p-5 bg-white shadow-md w-full h-full text-black aspect-[210/297]" ref={containerRef}>
      <div style={{
        zoom: (1 / 795) * width
      }}>
        ...
        <p className="border-b-4 py-3 border-black whitespace-pre">
          {resume?.objective}
        </p>
        {resume?.experience[0].companyName && 
        <div className="border-b-4 py-3 border-black">
